...
function PlayerTracker(gameServer, socket) {
    ...
    this.isMi = 0;
    this.isBot = 0;
    this.minion = {//to do: change all 0s to false and all 1s to true where applicable
        control: 0,
        split: 0,
        eject: 0,
        frozen: 0,
...
PlayerTracker.prototype.sendUpdate = function() {
    if (this.isRemoved || !this.socket.packetHandler.protocol || !this.socket.isConnected || this.isMi || this.isMinion ||
        (this.socket._socket.writable != null && !this.socket._socket.writable) || this.socket.readyState != this.socket.OPEN) return;
...
PlayerTracker.prototype.pressSpace = function() {
    if (this.gameServer.running && !this.spectating && !this.mergeOverride) this.gameServer.splitCells(this);
};

PlayerTracker.prototype.pressW = function() {
    if (this.gameServer.running && !this.spectating) this.gameServer.ejectMass(this);
};
